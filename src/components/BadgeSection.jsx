    ...
    <>
      <div className="badge-card-own" style={{ '--badge-color': color, '--badge-bg': bg }}>
        <div className="badge-card-top">
          ...
          {pct !== null && level > 0 && (
            <span className="badge-card-pct-pill">Top {pct}%</span>
          )}
        </div>

        <div className="badge-card-hero" onClick={() => setOpen(true)} title="Voir tous les niveaux">
          ...
          <div className="badge-card-identity">
            ...
            <span className="badge-card-level-label">Niveau {level}</span>
          </div>
        </div>
        ...
        {!isMax && (
          <div className="badge-card-progress-section">
            <div className="badge-card-next-row">
              <span className="badge-card-next-label">Prochain : {progress.nextIcon} {progress.nextName}</span>
