export const MYANMAR = {
  code: "MMR",
  numericId: 104,
  name: { fr: "Myanmar", en: "Myanmar", es: "Myanmar" },
  emoji: "🇲🇲",
  capital: { fr: "Naypyidaw", en: "Naypyidaw", es: "Naipyidó" },
  language: { fr: "Birman", en: "Burmese", es: "Birmano" },
  currency: { fr: "Kyat birman (MMK)", en: "Burmese kyat (MMK)", es: "Kiat birmano (MMK)" },
  timezone: "UTC+6:30",
  filter: {
    budgetMin: 30,
    budgetMid: 60,
  ...
  description: {
    ...
    es: "Myanmar (Birmania) es un destino de una belleza y profundidad espiritual excepcionales: la llanura de Bagan con sus miles de templos budistas, el lago Inle y sus pescadores en piragua, Mandalay y sus monasterios. Nota: consulte los avisos de viaje antes de partir debido a la situación política.",
  },
  ...
  bestPeriods: [
    {
      ...
      description: {
        ...
        es: "Mejor época: temperaturas agradables (20–30 °C), sin lluvia, ideal para Bagan y el lago Inle.",
      },
      icon: "☀️",
    },
    {
      months: { fr: "Mars – Mai", en: "March – May", es: "Marzo – Mayo" },
      label: { fr: "Chaud et sec", en: "Hot and dry", es: "Cálido y seco" },
      color: "#fb923c",
      description: {
        ...
        es: "Muy caluroso (35–40 °C) pero aún seco. Menos turistas, atardeceres espectaculares sobre Bagan.",
      },
      icon: "🌅",
    },
  ],
  ...
  weatherCities: [
    {
      id: "yangon",
      name: "Yangon",
      region: { fr: "Yangon (ancienne capitale)", en: "Yangon (former capital)", es: "Yangón (antigua capital)" },
      data: [
    ...
    },
    {
      id: "mandalay",
      name: "Mandalay",
      region: { fr: "Mandalay", en: "Mandalay", es: "Mandalay" },
      data: [
  ...
  destinations: [
    {
      ...
      mustSee: [
        ...
        { name: { fr: "Montgolfière au lever du soleil", en: "Hot-air balloon at sunrise", es: "Globo aerostático al amanecer" }, wikipedia: "Bagan" },
      ],
    },
    {
      id: 2,
      name: { fr: "Lac Inle", en: "Inle Lake", es: "Lago Inle" },
      region: { fr: "Shan", en: "Shan", es: "Shan" },
      description: {
      ...
      mustSee: [
        ...
        { name: { fr: "Jardins flottants Inle", en: "Inle floating gardens", es: "Jardines flotantes de Inle" }, wikipedia: "File:Inle Lake, House on the lake, Myanmar.jpg" },
      ],
    },
    {
      id: 3,
      ...
      mustSee: [
        ...
        { name: { fr: "Monastère Shwenandaw", en: "Shwenandaw Monastery", es: "Monasterio Shwenandaw" }, wikipedia: "Shwenandaw_Monastery" },
      ],
    },
    {
      id: 4,
      name: "Yangon",
      region: { fr: "Yangon", en: "Yangon", es: "Yangón" },
      description: {
      ...
      mustSee: [
        ...
        { name: { fr: "Quartier colonial (Downtown Yangon)", en: "Colonial quarter (Downtown Yangon)", es: "Barrio colonial (Downtown Yangón)" }, wikipedia: "Downtown_Yangon" },
      ],
    },
  ],
  ...
  costOfLiving: {
    intro: {
      ...
      es: "Myanmar es un destino asequible. El kiat local se usa a diario, pero el dólar estadounidense ha sido tradicionalmente muy aceptado para los servicios turísticos.",
    },
    currency: { fr: "Kyat birman (MMK)", en: "Burmese kyat (MMK)", es: "Kiat birmano (MMK)" },
    ...
    categories: [
      {
        ...
        items: [
          { label: { fr: "Dortoir guesthouse", en: "Guesthouse dorm", es: "Dormitorio en guesthouse" }, price: "5–10 €", detail: { fr: "Yangon, Bagan, Mandalay", en: "Yangon, Bagan, Mandalay", es: "Yangón, Bagan, Mandalay" } },
          { label: { fr: "Chambre double guesthouse", en: "Guesthouse double room", es: "Habitación doble en guesthouse" }, price: "15–35 €", detail: { fr: "Bon confort avec AC", en: "Good comfort with AC", es: "Buen confort con aire acondicionado" } },
          { label: { fr: "Hôtel boutique 4★", en: "4★ boutique hotel", es: "Hotel boutique 4★" }, price: "60–150 €", detail: { fr: "Bagan ou Inle Lake avec vue", en: "Bagan or Inle Lake with a view", es: "Bagan o lago Inle con vistas" } },
        ],
      },
      {
        id: "food",
        ...
        items: [
          { label: { fr: "Mohinga (soupe nationale)", en: "Mohinga (national soup)", es: "Mohinga (sopa nacional)" }, price: "0,50–1 €", detail: { fr: "Petit-déjeuner birman classique", en: "Classic Burmese breakfast", es: "Desayuno birmano clásico" } },
          { label: { fr: "Repas dans une tea house", en: "Meal at a tea house", es: "Comida en una tea house" }, price: "1,50–3 €", detail: { fr: "Riz + curry + légumes, très typique", en: "Rice + curry + vegetables, very typical", es: "Arroz + curry + verduras, muy típico" } },
          { label: { fr: "Restaurant touristique", en: "Tourist restaurant", es: "Restaurante turístico" }, price: "5–15 €", detail: { fr: "Cuisine birmane ou internationale", en: "Burmese or international cuisine", es: "Cocina birmana o internacional" } },
        ],
      },
      {
        id: "transport",
        ...
        items: [
          { label: { fr: "Bus express Yangon–Bagan (nuit, 8h)", en: "Express bus Yangon–Bagan (overnight, 8h)", es: "Autobús exprés Yangón–Bagan (nocturno, 8h)" }, price: "8–15 €", detail: { fr: "Confortable, AC, départ nocturne", en: "Comfortable, AC, overnight departure", es: "Cómodo, aire acondicionado, salida nocturna" } },
          { label: { fr: "Vol intérieur (ex: Yangon–Mandalay)", en: "Domestic flight (e.g. Yangon–Mandalay)", es: "Vuelo interior (ej: Yangón–Mandalay)" }, price: "30–80 €", detail: { fr: "KBZ Air ou Air KBZ, 1h de vol", en: "KBZ Air or Air KBZ, 1h flight", es: "KBZ Air o Air KBZ, 1h de vuelo" } },
        ],
      },
      {
        id: "activities",
        ...
        items: [
          { label: { fr: "Entrée Bagan (zone archéologique)", en: "Bagan entrance (archaeological zone)", es: "Entrada a Bagan (zona arqueológica)" }, price: "20–25 €", detail: { fr: "Valable plusieurs jours", en: "Valid for several days", es: "Válida varios días" } },
          { label: { fr: "Montgolfière Bagan", en: "Bagan hot-air balloon", es: "Globo aerostático en Bagan" }, price: "300–400 €", detail: { fr: "Coucher/lever de soleil, 1h de vol", en: "Sunrise/sunset, 1h flight", es: "Amanecer/atardecer, 1h de vuelo" } },
        ],
      },
    ],
    budgetSummary: [
      { type: { fr: "Routard", en: "Backpacker", es: "Mochilero" }, daily: "30–50 €/j", desc: { fr: "Guesthouse, tea house, bus, excursions budget", en: "Guesthouse, tea house, bus, budget excursions", es: "Guesthouse, tea house, autobús, excursiones económicas" }, color: "#22c55e" },
      { type: { fr: "Confort", en: "Comfort", es: "Confort" }, daily: "60–100 €/j", desc: { fr: "Hôtel 3★, restaurants, vols intérieurs", en: "3★ hotel, restaurants, domestic flights", es: "Hotel 3★, restaurantes, vuelos interiores" }, color: "#3b82f6" },
      { type: { fr: "Luxe", en: "Luxury", es: "Lujo" }, daily: "200 €+/j", desc: { fr: "Lodge 5★ Inle, montgolfière, tours privés", en: "5★ Inle lodge, hot-air balloon, private tours", es: "Lodge 5★ en Inle, globo aerostático, tours privados" }, color: "#f59e0b" },
    ],
    tripEstimate: {
      duration: { fr: "2 semaines", en: "2 weeks", es: "2 semanas" },
      route: { fr: "Yangon – Bagan – Mandalay – Lac Inle", en: "Yangon – Bagan – Mandalay – Inle Lake", es: "Yangón – Bagan – Mandalay – Lago Inle" },
      budgets: [
        {
          ...
          breakdown: [
            { label: { fr: "Vol A/R Paris–Yangon", en: "Return flight Paris–Yangon", es: "Vuelo ida y vuelta Madrid–Yangón" }, amount: "550–800 €" },
            ...
            { label: { fr: "Transport local + bus/train", en: "Local transport + bus/train", es: "Transporte local + autobús/tren" }, amount: "100–200 €" },
        ...
        },
        {
          ...
          includesFlights: true,
          breakdown: [
            { label: { fr: "Vol A/R Paris–Yangon", en: "Return flight Paris–Yangon", es: "Vuelo ida y vuelta Madrid–Yangón" }, amount: "700–1 000 €" },
            ...
            { label: { fr: "Transport + vols intérieurs", en: "Transport + domestic flights", es: "Transporte + vuelos interiores" }, amount: "300–500 €" },
        ...
        },
        {
          ...
          includesFlights: true,
          breakdown: [
            { label: { fr: "Vol A/R Paris–Yangon (Business)", en: "Return flight Paris–Yangon (Business)", es: "Vuelo ida y vuelta Madrid–Yangón (Business)" }, amount: "2 500–3 500 €" },
            { label: { fr: "Hébergement (14 nuits)", en: "Accommodation (14 nights)", es: "Alojamiento (14 noches)" }, amount: "1 200–1 800 €" },
            { label: { fr: "Montgolfière Bagan", en: "Bagan hot-air balloon", es: "Globo aerostático en Bagan" }, amount: "400–600 €" },
  ...
  practicalities: [
    { icon: "✈️", label: { fr: "Vol depuis Paris", en: "Flight from Paris", es: "Vuelo desde Madrid" }, value: { fr: "~13–15h avec escale (Bangkok, Singapour, KL)", en: "~13–15h with a layover (Bangkok, Singapore, KL)", es: "~13–15h con escala (Bangkok, Singapur, KL)" } },
    { icon: "🪪", label: { fr: "Visa", en: "Visa", es: "Visado" }, value: { fr: "e-Visa recommandé (50 USD) — vérifiez la situation actuelle", en: "e-Visa recommended (50 USD) — check the current situation", es: "Se recomienda e-Visa (50 USD) — consulte la situación actual" } },
    { icon: "💰", label: { fr: "Monnaie", en: "Currency", es: "Moneda" }, value: { fr: "Kyat birman (1€ ≈ 2 000–2 500 MMK) — USD utiles", en: "Burmese kyat (1€ ≈ 2,000–2,500 MMK) — USD useful", es: "Kiat birmano (1€ ≈ 2.000–2.500 MMK) — dólares útiles" } },
    { icon: "🗣️", label: { fr: "Langue", en: "Language", es: "Idioma" }, value: { fr: "Birman (l'anglais est parlé dans le tourisme)", en: "Burmese (English spoken in tourism)", es: "Birmano (el inglés se habla en el sector turístico)" } },
    { icon: "🔌", label: { fr: "Prise électrique", en: "Power outlet", es: "Enchufe eléctrico" }, value: { fr: "Type A/C/D/G – 230 V (adaptateur universel)", en: "Type A/C/D/G – 230 V (universal adapter)", es: "Tipo A/C/D/G – 230 V (adaptador universal)" } },
    { icon: "📱", label: { fr: "Réseau", en: "Network", es: "Red" }, value: { fr: "4G dans les grandes villes, SIM locale à l'arrivée", en: "4G in major cities, local SIM on arrival", es: "4G en las grandes ciudades, SIM local a la llegada" } },
    ...
    { icon: "💊", label: { fr: "Santé", en: "Health", es: "Salud" }, value: { fr: "Antipaludéens recommandés pour les zones rurales, vaccins hépatite A/B", en: "Antimalarials recommended for rural areas, hepatitis A/B vaccines", es: "Se recomiendan antipalúdicos para zonas rurales, vacunas hepatitis A/B" } },
  ],
};
