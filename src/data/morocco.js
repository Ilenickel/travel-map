export const MOROCCO = {
  ...
  destinations: [
    ...
    },
    {
      ...
      region: "Côte Atlantique",
      description:
        "Première ville du Maroc et capitale économique, Casablanca est souvent négligée par les touristes au profit de Marrakech ou Fès — à tort. La mosquée Hassan II, avec son minaret de 210 m le plus haut du monde, est un chef-d'œuvre architectural surplombant l'Atlantique. L'architecture Art Déco du centre-ville, le quartier animé d'Anfa et la corniche en bord de mer révèlent une ville moderne et cosmopolite.",
      wikipedia: "Casablanca",
      tags: ["Ville", "Architecture", "Culture", "Gastronomie", "Histoire", "Plage"],
      mustSee: [
        { name: "Mosquée Hassan II — minaret de 210 m sur l'Atlantique", wikipedia: "Hassan_II_Mosque" },
        { name: "Quartier Art Déco — architecture coloniale des années 1930", wikipedia: "File:Casablanca Art Deco (5519785011).jpg" },
        { name: "Corniche & plages d'Ain Diab", wikipedia: "File:Une plage à El Mansouria.jpg" },
        { name: "Ancienne médina & quartier Habous", wikipedia: "File:Quartiers des Habbous à Casablanca.jpg" },
      ],
    },
  ],
