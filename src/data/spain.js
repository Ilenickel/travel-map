export const SPAIN = {
  ...
  destinations: [
    ...
    },
    {
      ...
      mustSee: [
        { name: "Musée Guggenheim Bilbao — chef-d'œuvre d'architecture de Frank Gehry", wikipedia: "Guggenheim_Museum_Bilbao" },
        { name: "Pintxos dans le Casco Viejo — bar-hopping gastronomique basque", wikipedia: "File:Pincho Vitoria 11.JPG" },
        { name: "San Sebastián (Donostia) — plage de La Concha et gastronomie étoilée", wikipedia: "File:San Sebastian Zurriola beach 1190579.jpg" },
        { name: "Côte Cantabrique & falaises de Gaztelugatxe", wikipedia: "File:San-juan-de-gaztelugatxe.jpg" },
      ],
    },
    {
      id: 8,
      ...
      mustSee: [
        { name: "Teide — volcan à 3 718 m, toit de l'Espagne (Tenerife)", wikipedia: "Teide" },
        { name: "Parc national de Timanfaya — paysage lunaire volcanique (Lanzarote)", wikipedia: "Timanfaya_National_Park" },
        { name: "Maspalomas & Dunes (Gran Canaria) — mer de sable au bord de l'Atlantique", wikipedia: "Maspalomas" },
        { name: "Los Gigantes — falaises vertigineuses plongeant dans l'Atlantique (Tenerife)", wikipedia: "Los_Gigantes" },
      ],
    },
  ],
