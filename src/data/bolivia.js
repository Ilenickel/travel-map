export const BOLIVIA = {
  code: "BOL",
  numericId: 68,
  name: { fr: "Bolivie", en: "Bolivia", es: "Bolivia" },
  emoji: "🇧🇴",
  capital: {
    fr: "Sucre (constitutionnelle) / La Paz (siège du gouvernement)",
    en: "Sucre (constitutional capital) / La Paz (seat of government)",
    es: "Sucre (constitucional) / La Paz (sede del gobierno)",
  },
  language: { fr: "Espagnol, quechua, aymara", en: "Spanish, Quechua, Aymara", es: "Español, quechua, aimara" },
  currency: { fr: "Boliviano (BOB)", en: "Boliviano (BOB)", es: "Boliviano (BOB)" },
  timezone: "UTC-4",
  filter: {
    budgetMin: 25,
    budgetMid: 55,
  ...
  description: {
    ...
    es: "Bolivia es uno de los países más auténticos y asequibles de Sudamérica. Entre el Salar de Uyuni (el mayor desierto de sal del mundo), La Paz encaramada a 3650 m, el lago Titicaca y la Amazonía, ofrece una diversidad extraordinaria con un presupuesto reducido.",
  },
  ...
  bestPeriods: [
    {
      ...
      description: {
        ...
        es: "La mejor época para el Salar de Uyuni y los Andes. Días soleados, noches frías, carreteras transitables.",
      },
      icon: "☀️",
    },
    {
      months: { fr: "Novembre – Avril", en: "November – April", es: "Noviembre – Abril" },
      label: { fr: "Saison des pluies (miroir Uyuni)", en: "Rainy season (Uyuni mirror effect)", es: "Estación de lluvias (efecto espejo en Uyuni)" },
      color: "#38bdf8",
      description: {
        ...
        es: "Cubierto de agua, el Uyuni se convierte en un espejo gigante que refleja el cielo — una imagen icónica. Algunas carreteras pueden quedar intransitables.",
      },
      icon: "🪞",
    },
  ],
  ...
  weatherCities: [
    {
      id: "la-paz",
      name: "La Paz",
      region: { fr: "Andes (3 650 m)", en: "Andes (3,650 m)", es: "Andes (3650 m)" },
      data: [
    ...
    },
    {
      id: "sucre",
      name: "Sucre",
      region: { fr: "Chuquisaca", en: "Chuquisaca", es: "Chuquisaca" },
      data: [
    ...
    },
    {
      id: "uyuni",
      name: "Uyuni",
      region: { fr: "Potosí (Altiplano)", en: "Potosí (Altiplano)", es: "Potosí (Altiplano)" },
      data: [
  ...
  destinations: [
    {
      id: 1,
      name: { fr: "Salar d'Uyuni", en: "Uyuni Salt Flat", es: "Salar de Uyuni" },
      region: { fr: "Altiplano", en: "Altiplano", es: "Altiplano" },
      description: {
      ...
      mustSee: [
        ...
        { name: { fr: "Sol de Mañana (geysers)", en: "Sol de Mañana (geysers)", es: "Sol de Mañana (géiseres)" }, wikipedia: "File:Sol de Mañana 2018.jpg" },
      ],
    },
    {
      id: 2,
      ...
      mustSee: [
        ...
        { name: { fr: "Valle de la Luna (La Paz)", en: "Valley of the Moon (La Paz)", es: "Valle de la Luna (La Paz)" }, wikipedia: "Valle_de_la_Luna_(Bolivia)" },
      ],
    },
    {
      id: 3,
      ...
      mustSee: [
        ...
        { name: { fr: "Copacabana (Bolivie)", en: "Copacabana (Bolivia)", es: "Copacabana (Bolivia)" }, wikipedia: "Copacabana,_Bolivia" },
        { name: { fr: "Ruines de Tiwanaku", en: "Tiwanaku Ruins", es: "Ruinas de Tiwanaku" }, wikipedia: "Tiwanaku" },
      ],
    },
    {
      id: 4,
      ...
      mustSee: [
        ...
        { name: { fr: "Recoleta (belvédère)", en: "Recoleta viewpoint", es: "Recoleta (mirador)" }, wikipedia: "File:Cerro San Cristobal - Vistas desde Cumbre - Recoleta - 04.jpg" },
        { name: { fr: "Cal Orck'o (dinosaures)", en: "Cal Orck'o (dinosaurs)", es: "Cal Orck'o (dinosaurios)" }, wikipedia: "File:Dinosaur Valley in Cal Orcko Bolivia (photos canned).jpg" },
      ],
    },
  ],
  ...
  costOfLiving: {
    intro: {
      ...
      es: "Bolivia es uno de los destinos más baratos de Sudamérica. Los precios son muy bajos en alojamiento, comida y transporte.",
    },
    ...
    categories: [
      {
        ...
        items: [
          { label: { fr: "Dortoir auberge de jeunesse", en: "Hostel dorm", es: "Dormitorio en albergue" }, price: "5–10 €", detail: { fr: "La Paz, Uyuni, Sucre", en: "La Paz, Uyuni, Sucre", es: "La Paz, Uyuni, Sucre" } },
          { label: { fr: "Chambre double hôtel simple", en: "Basic hotel double room", es: "Habitación doble en hotel sencillo" }, price: "15–30 €", detail: { fr: "Confort basique à correct", en: "Basic to decent comfort", es: "Confort básico a correcto" } },
          { label: { fr: "Hôtel de sel (Uyuni)", en: "Salt hotel (Uyuni)", es: "Hotel de sal (Uyuni)" }, price: "50–120 €", detail: { fr: "Expérience unique, murs et sol en sel", en: "Unique experience, with salt walls and floors", es: "Experiencia única, muros y suelo de sal" } },
        ],
      },
      {
        id: "food",
        ...
        items: [
          { label: { fr: "Menú del día (menu local)", en: "Menú del día (local set menu)", es: "Menú del día" }, price: "1,5–3 €", detail: { fr: "Soupe + plat + boisson, très complet", en: "Soup + main dish + drink, very filling", es: "Sopa + plato + bebida, muy completo" } },
          { label: { fr: "Salteña (chausson bolivien)", en: "Salteña (Bolivian savoury pastry)", es: "Salteña" }, price: "0,50–1 €", detail: { fr: "Snack du matin, délicieux", en: "A delicious morning snack", es: "Tentempié matutino, delicioso" } },
          { label: { fr: "Restaurant touristique", en: "Tourist restaurant", es: "Restaurante turístico" }, price: "6–15 €", detail: { fr: "La Paz ou Sucre, cuisine andine", en: "In La Paz or Sucre, serving Andean cuisine", es: "En La Paz o Sucre, cocina andina" } },
        ],
      },
      {
        id: "transport",
        ...
        items: [
          { label: { fr: "Bus La Paz–Uyuni (nuit)", en: "La Paz–Uyuni bus (overnight)", es: "Autobús La Paz–Uyuni (nocturno)" }, price: "8–15 €", detail: { fr: "Route longue (10h), préférer le jour", en: "Long journey (10h), daytime travel is preferable", es: "Trayecto largo (10h), preferible de día" } },
          { label: { fr: "Tour Salar d'Uyuni (3 jours)", en: "Uyuni Salt Flat tour (3 days)", es: "Tour al Salar de Uyuni (3 días)" }, price: "50–80 €", detail: { fr: "Tout compris, en groupe, depuis Uyuni", en: "All-inclusive, shared tour, departing from Uyuni", es: "Todo incluido, en grupo, desde Uyuni" } },
        ],
      },
      {
        id: "activities",
        ...
        items: [
          { label: { fr: "Téléphérique Mi Teleférico La Paz", en: "Mi Teleférico cable car in La Paz", es: "Teleférico Mi Teleférico en La Paz" }, price: "0,50 €", detail: { fr: "Par ligne, vues exceptionnelles", en: "Per line, with exceptional views", es: "Por línea, vistas excepcionales" } },
          { label: { fr: "Excursion Isla del Sol (Titicaca)", en: "Isla del Sol excursion (Titicaca)", es: "Excursión a la Isla del Sol (Titicaca)" }, price: "10–20 €", detail: { fr: "Bateau + guide, journée", en: "Boat + guide, full-day trip", es: "Barco + guía, día completo" } },
        ],
      },
    ],
    budgetSummary: [
      { type: { fr: "Routard", en: "Backpacker", es: "Mochilero" }, daily: "25–40 €/j", desc: { fr: "Auberge, menú local, bus, tours en groupe", en: "Hostel, local set menus, buses and shared tours", es: "Albergue, menú local, autobús, tours en grupo" }, color: "#22c55e" },
      { type: { fr: "Confort", en: "Comfort", es: "Confort" }, daily: "55–90 €/j", desc: { fr: "Hôtel correct, restaurants, tours guidés", en: "Decent hotel, restaurants and guided tours", es: "Hotel correcto, restaurantes, tours guiados" }, color: "#3b82f6" },
      { type: { fr: "Luxe", en: "Luxury", es: "Lujo" }, daily: "150 €+/j", desc: { fr: "Hôtel de luxe, tours privés, vols intérieurs", en: "Luxury hotel, private tours and domestic flights", es: "Hotel de lujo, tours privados, vuelos internos" }, color: "#f59e0b" },
    ],
    tripEstimate: {
      duration: { fr: "2 semaines", en: "2 weeks", es: "2 semanas" },
      route: { fr: "La Paz – Lac Titicaca – Sucre – Uyuni", en: "La Paz – Lake Titicaca – Sucre – Uyuni", es: "La Paz – Lago Titicaca – Sucre – Uyuni" },
      budgets: [
        {
          ...
          breakdown: [
            { label: { fr: "Vol A/R Paris–La Paz", en: "Return flight Paris–La Paz", es: "Vuelo ida y vuelta Madrid–La Paz" }, amount: "700–900 €" },
            ...
            { label: { fr: "Transport local + tours", en: "Local transport + tours", es: "Transporte local + tours" }, amount: "100–180 €" },
        ...
        },
        {
          ...
          includesFlights: true,
          breakdown: [
            { label: { fr: "Vol A/R Paris–La Paz", en: "Return flight Paris–La Paz", es: "Vuelo ida y vuelta Madrid–La Paz" }, amount: "900–1 200 €" },
            ...
            { label: { fr: "Transport + tours guidés", en: "Transport + guided tours", es: "Transporte + tours guiados" }, amount: "250–400 €" },
        ...
        },
        {
          ...
          includesFlights: true,
          breakdown: [
            { label: { fr: "Vol A/R Paris–La Paz (Business)", en: "Return flight Paris–La Paz (business)", es: "Vuelo ida y vuelta Madrid–La Paz (business)" }, amount: "2 500–3 500 €" },
            ...
            { label: { fr: "Activités premium", en: "Premium activities", es: "Actividades premium" }, amount: "200–400 €" },
          ],
        },
      ],
    },
  ...
  practicalities: [
    { icon: "✈️", label: { fr: "Vol depuis Paris", en: "Flight from Paris", es: "Vuelo desde Madrid" }, value: { fr: "~14–16h avec escale (Lima ou Bogotá)", en: "~14–16h with a layover (Lima or Bogotá)", es: "~14–16h con escala (Lima o Bogotá)" } },
    ...
    { icon: "💰", label: { fr: "Monnaie", en: "Currency", es: "Moneda" }, value: { fr: "Boliviano (1€ ≈ 7,5–8 BOB)", en: "Boliviano (€1 ≈ 7.5–8 BOB)", es: "Boliviano (1€ ≈ 7,5–8 BOB)" } },
    { icon: "🗣️", label: { fr: "Langue", en: "Language", es: "Idioma" }, value: { fr: "Espagnol, quechua, aymara", en: "Spanish, Quechua, Aymara", es: "Español, quechua, aimara" } },
    { icon: "🔌", label: { fr: "Prise électrique", en: "Power outlet", es: "Enchufe eléctrico" }, value: { fr: "Type A/C – 220 V (adaptateur conseillé)", en: "Type A/C – 220 V (adapter recommended)", es: "Tipo A/C – 220 V (adaptador recomendado)" } },
  ],
};
