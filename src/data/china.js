export const CHINA = {
  ...
  destinations: [
    ...
    },
    {
      ...
      region: "Guangdong",
      description:
        "Ville futuriste construite en quarante ans à partir d'un village de pêcheurs, Shenzhen est la vitrine technologique de la Chine. Gratte-ciels spectaculaires, quartiers créatifs, parcs à thème géants et belles plages sur la côte de Dapeng en font une destination à la fois moderne et balnéaire.",
      wikipedia: "Shenzhen",
      tags: ["Ville", "Architecture", "Plage", "Gastronomie"],
      mustSee: [
        { name: "Baie de Shenzhen — skyline nocturne", wikipedia: "File:SHENZHEN BAY (DEEP BAY) (38).jpg" },
        { name: "Plage de Dameisha", wikipedia: "File:大梅沙愿望塔鸟瞰沙滩.jpg" },
        ...
        { name: "Futian CBD & Ping An Finance Centre", wikipedia: "File:Shenzhen_Skyline_Fuhua_Road_Ping_An_International_Finance_Center.jpg" },
      ],
    },
  ],
