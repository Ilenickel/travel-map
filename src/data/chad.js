export const CHAD = {
  ...
  emoji: "🇹🇩",
  capital: "N'Djamena",
  language: { fr: "Français, Arabe tchadien", en: "French, Chadian Arabic" },
  ...
  weatherCities: [
    {
      id: "ndjamena",
      name: "N'Djamena",
      region: { fr: "Capitale (Sahel)", en: "Capital (Sahel)" },
      data: [
    ...
    },
    {
      id: "faya",
      name: "Faya-Largeau",
      region: { fr: "Borkou (Désert saharien)", en: "Borkou (Saharan Desert)" },
      data: [
  ...
  destinations: [
    {
      id: 1,
      name: { fr: "Plateau de l'Ennedi", en: "Ennedi Plateau" },
      region: { fr: "Région d'Ennedi (nord-est)", en: "Ennedi Region (northeast)" },
      description: {
      ...
      mustSee: [
        { name: { fr: "Arche d'Aloba — l'une des plus grandes arches naturelles du monde", en: "Aloba Arch — one of the largest natural arches in the world" }, wikipedia: "Aloba_Arch" },
        { name: { fr: "Guelta d'Archei — oasis avec crocodiles sahariens reliques", en: "Guelta d'Archei — oasis with relic Saharan crocodiles" }, wikipedia: "Guelta_d'Archei" },
        { name: { fr: "Peintures rupestres de l'Ennedi — art préhistorique saharien", en: "Ennedi rock paintings — prehistoric Saharan art" }, wikipedia: "File:Kamel Terkei.jpg" },
        { name: { fr: "Bichagara — formation rocheuse et camp nomade touareg", en: "Bichagara — rock formation and Tuareg nomad camp" }, wikipedia: "File:Camels in Hope of a Drink (23555725233).jpg" },
      ],
    },
    {
      id: 2,
      name: { fr: "Parc National de Zakouma", en: "Zakouma National Park" },
      region: { fr: "Région du Salamat (sud-est)", en: "Salamat Region (southeast)" },
      description: {
      ...
      mustSee: [
        { name: { fr: "Troupeaux d'éléphants — regroupements spectaculaires en saison sèche", en: "Elephant herds — spectacular gatherings in the dry season" }, wikipedia: "File:Elephant du parc national de Zakouma.jpg" },
        { name: { fr: "Lions de Zakouma — meutes emblématiques du parc", en: "Zakouma lions — the park's iconic prides" }, wikipedia: "Zakouma_National_Park" },
        { name: { fr: "Lac Zakouma — point d'eau central avec hippos et oiseaux", en: "Lake Zakouma — central watering hole with hippos and birds" }, wikipedia: "Zakouma_National_Park" },
        { name: { fr: "Goz Beida — ville de départ avec camp de réfugiés et ONG", en: "Goz Beida — starting town with a refugee camp and NGOs" }, wikipedia: "File:Goz beida.jpg" },
      ],
    },
    {
      id: 3,
      name: { fr: "Lac Tchad", en: "Lake Chad" },
      region: { fr: "Région du Lac (ouest)", en: "Lac Region (west)" },
      description: {
      ...
      mustSee: [
        { name: { fr: "Villages buduma — communautés de pêcheurs sur les îles du lac", en: "Buduma villages — fishing communities on the lake's islands" }, wikipedia: "File:Habitat d’un boudouma du Tchad.jpg" },
        { name: { fr: "N'Djamena — capitale avec grand marché central", en: "N'Djamena — capital with a large central market" }, wikipedia: "N'Djamena" },
        { name: { fr: "Musée National du Tchad — collections archéologiques et ethnographiques", en: "National Museum of Chad — archaeological and ethnographic collections" }, wikipedia: "File:Musée national 2.jpg" },
        { name: { fr: "Bol — principale ville riveraine du lac", en: "Bol — the lake's main lakeside town" }, wikipedia: "Bol,_Chad" },
      ],
    },
  ],
    ...
    categories: [
      {
        ...
        items: [
          { label: { fr: "Auberge / chambre basique", en: "Basic guesthouse / room" }, price: "10–25 €" },
          { label: { fr: "Hôtel milieu de gamme (N'Djamena)", en: "Mid-range hotel (N'Djamena)" }, price: "40–80 €" },
          { label: { fr: "Camp safari (Zakouma)", en: "Safari camp (Zakouma)" }, price: "150–300 €" },
        ],
      },
      {
        id: "food",
        ...
        items: [
          { label: { fr: "Gargote locale (riz, viande)", en: "Local eatery (rice, meat)" }, price: "2–5 €" },
          { label: { fr: "Restaurant en ville", en: "Restaurant in town" }, price: "8–20 €" },
          { label: { fr: "Provisions pour expédition", en: "Supplies for an expedition" }, price: "10–20 €/j" },
        ],
      },
      {
        id: "transport",
        ...
        items: [
          { label: { fr: "Taxi en ville (N'Djamena)", en: "City taxi (N'Djamena)" }, price: "2–5 €" },
          { label: { fr: "Location 4x4 avec chauffeur", en: "4x4 rental with driver" }, price: "100–200 €/j" },
          { label: { fr: "Vol intérieur (N'Djamena–Abéché)", en: "Domestic flight (N'Djamena–Abéché)" }, price: "100–200 €" },
        ],
      },
      {
        id: "activities",
        ...
        items: [
          { label: { fr: "Entrée parc de Zakouma (par jour)", en: "Zakouma park entry (per day)" }, price: "20–40 €" },
          { label: { fr: "Guide pour l'Ennedi (forfait)", en: "Ennedi guide (package)" }, price: "80–150 €/j" },
          { label: { fr: "Excursion lac Tchad depuis Bol", en: "Lake Chad excursion from Bol" }, price: "30–60 €" },
        ],
      },
    ],
    budgetSummary: [
      { type: { fr: "Routard", en: "Backpacker" }, daily: "45–70 €/j", desc: { fr: "Hébergement simple, nourriture locale, hors logistique expédition", en: "Simple accommodation, local food, excluding expedition logistics" }, color: "#22c55e" },
      { type: { fr: "Confort", en: "Comfort" }, daily: "90–200 €/j", desc: { fr: "Hôtel correct, camp safari, guide et 4x4 inclus", en: "Decent hotel, safari camp, guide and 4x4 included" }, color: "#3b82f6" },
    ],
    tripEstimate: {
      duration: { fr: "12 jours", en: "12 days" },
      route: { fr: "N'Djamena → Zakouma (safari) → Abéché → Plateau de l'Ennedi", en: "N'Djamena → Zakouma (safari) → Abéché → Ennedi Plateau" },
      budgets: [
        {
          ...
          breakdown: [
            { label: { fr: "Vol A/R Paris–N'Djamena", en: "Return flight Paris–N'Djamena" }, amount: "450–650 €" },
            { label: { fr: "Hébergement (11 nuits)", en: "Accommodation (11 nights)" }, amount: "150–300 €" },
        ...
        },
        {
          ...
          includesFlights: true,
          breakdown: [
            { label: { fr: "Vol A/R Paris–N'Djamena", en: "Return flight Paris–N'Djamena" }, amount: "500–700 €" },
            { label: { fr: "Hébergement (11 nuits)", en: "Accommodation (11 nights)" }, amount: "440–900 €" },
            { label: { fr: "Location 4x4 + carburant", en: "4x4 rental + fuel" }, amount: "600–1 000 €" },
            { label: { fr: "Nourriture + boissons", en: "Food + drinks" }, amount: "300–450 €" },
            { label: { fr: "Activités + guides", en: "Activities + guides" }, amount: "350–600 €" },
          ],
        },
      ],
    },
  ...
  practicalities: [
    { icon: "✈️", label: { fr: "Vol depuis Paris", en: "Flight from Paris" }, value: { fr: "Vols via Casablanca (Royal Air Maroc), Addis-Abeba (Ethiopian) ou Paris direct avec Air France selon saison. Durée totale ~8–12h.", en: "Flights via Casablanca (Royal Air Maroc), Addis Ababa (Ethiopian) or direct from Paris with Air France depending on season. Total duration ~8–12h." } },
    { icon: "🪪", label: { fr: "Visa", en: "Visa" }, value: { fr: "Visa obligatoire. Obtention en ambassade du Tchad à Paris. Permis de photographie souvent requis séparément pour les sites sensibles.", en: "Visa required. Obtained from the Chadian embassy in Paris. A separate photography permit is often required for sensitive sites." } },
    { icon: "💰", label: { fr: "Monnaie", en: "Currency" }, value: { fr: "Franc CFA CEMAC (XAF). Espèces indispensables, peu de distributeurs en dehors de N'Djamena. Prévoyez largement en cash pour les expéditions.", en: "CEMAC CFA Franc (XAF). Cash is essential, few ATMs outside N'Djamena. Bring plenty of cash for expeditions." } },
    { icon: "🗣️", label: { fr: "Langue", en: "Language" }, value: { fr: "Français et arabe tchadien (langue du commerce). Dans le désert, les langues toubu et arabe local prédominent.", en: "French and Chadian Arabic (the trade language). In the desert, Toubou and local Arabic dialects predominate." } },
    { icon: "🔌", label: { fr: "Prise électrique", en: "Power outlet" }, value: { fr: "Type C et Type E (comme en France). Tension 220V. Électricité très aléatoire en dehors de N'Djamena.", en: "Type C and Type E (same as France). Voltage 220V. Power supply is very unreliable outside N'Djamena." } },
